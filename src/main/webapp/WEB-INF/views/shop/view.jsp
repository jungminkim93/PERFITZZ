...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/user/shop/default.css" />
			...
			<section id="content">
					...
					<div class="goodsInfo">
						...
						<p class="cartStock">
							...
							<input type="hidden" value="${view.gdsStock}" class="gdsStock_hidden" />
							 ...
							 <%-- <script src="${pageContext.request.contextPath}/resources/js/user/shop/stockBtn.js"></script> --%>
							<script>
				...
				<div id="reply">
							...
							<div class="input_area">
								...
								<script>
									$("#reply_btn").click(function(){
										//댓글 작성시 content값이 null로 전달되어 쿼리 실행이 안되신다면 $("textarea#content").val(); 
					...
					<section class="replyList">
						...
						<!-- 상품 소감 목록을 불러오는 스크립트를 하나의 함수로 묶음 -> 함수화로 재사용.
						 처음 상품 조회 페이지에 접속할 때 상품 소감 목록을 출력하고, 상품 소감을 새로 작성하거나, 수정하거나, 삭제할 경우에도 상품 소감 목록을 다시 출력-->
					 	<script>
							replyList();
						</script>
